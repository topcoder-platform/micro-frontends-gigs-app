...
const Scopes = {
  // JobApplication
  READ_JOBAPPLICATION: "read:gigs-jobApplications",
  READ_JOB: "read:gigs-job",
  READ_PROFILE: "read:gigs-profile",
  WRITE_PROFILE: "write:gigs-profile",
  ALL_PROFILE: "all:gig1s-profile",
};
