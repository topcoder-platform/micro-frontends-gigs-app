export const GIG_DETAILS_API_URL = `${process.env.URL.PLATFORM_WEBSITE_URL}${process.env.API_BASE_PATH}/job`;
...
export const CHALLENGE_LIST_URL = `${process.env.URL.PLATFORM_WEBSITE_URL}${process.env.CHALLENGE_LIST_PATH}`;
export const GIG_LIST_URL = `${process.env.URL.PLATFORM_WEBSITE_URL}${process.env.GIG_LIST_PATH}`;
